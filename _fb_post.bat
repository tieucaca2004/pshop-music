...
curl.exe -s -X POST "https://graph.facebook.com/v19.0/109215528208008/photos" ^
  -F "message=Nấm Đông Cô - siêu thực phẩm từ thiên nhiên
...
#NamDongCo #GiaTriDinhDuong #Sickhoe #DinhDuong #AmThuc #MonNgon #RauXao" ^
  -F "source=@D:\PshopMusicSite\media\inbound\openclaw-staged-28a4eb74-60f1-4add-83f6-2d2b0225e603\f26ca196-c637-4256-9d62-7357ad1afce8.jpg" ^
