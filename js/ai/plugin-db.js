 ...
 * 'faq-generator' (kích hoạt FAQ Generator sang Production). Các module còn
 * lại viết ở Sprint 1 giữ nguyên code nhưng đánh dấu "coming_soon" cho tới
 * khi được kích hoạt ở sprint sau.
 *
 ...
 * từ trước, Admin vẫn cần tự bật "Enable" cho FAQ Generator trong
 * admin/ai/plugins.html — đổi hằng số này không tự động bật lại cho môi
 * trường đã tồn tại dữ liệu.
 */
const SPRINT2_ENABLED_MODULES = ['product-description-writer', 'slider-generator', 'seo-generator', 'faq-generator'];
