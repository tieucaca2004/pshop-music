 ...
 * 'faq-generator'. Sprint 6 Requirement #1: thêm 'blog-writer' (kích hoạt
 * Blog Writer sang Production). Các module còn lại viết ở Sprint 1 giữ
 ...
 * từ trước, Admin vẫn cần tự bật "Enable" cho Blog Writer trong
 * admin/ai/plugins.html — đổi hằng số này không tự động bật lại cho môi
 * trường đã tồn tại dữ liệu.
 */
const SPRINT2_ENABLED_MODULES = ['product-description-writer', 'slider-generator', 'seo-generator', 'faq-generator', 'blog-writer'];
